...
class PersonalityForm extends React.Component {
    constructor(props) {
       super(props);
    //    this.state= {
    //     profile: this.props.getProfile(this.props.currentUser)
    //    } 
    }
    update(question) {
        return e => (this.setState((previousState) => ({
            [quiz_results]: previousState.quiz_results.push(e.currentTarget.value)
        }))); ;
    }
        ...
        return (
            <div id="personality">
               ...
               <form>Personality
                    ...
                    <label> If you were a Kardashian, which one would you be?
                    ...
                    <label> What is your go to cocktail?
                    ...
                    <label>Which house would the sorting hat place you in?
                    ...
                    <label>What is your favorite season?
                       <textarea className="personality-input" onChange={this.update("What is your favorite season?")}></textarea>
